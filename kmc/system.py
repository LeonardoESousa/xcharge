...
class System:
    ...
    def set_basic_info(self,monomolecular,processes,identifier,animation_mode,time_limit,pause,anni,distance,generation,cutoff):
        ...
        self.cutoff, self.FPcutoff            = cutoff
