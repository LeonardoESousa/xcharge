...
t1s   = {0:(3,0.0), 1:(2,0.0), 'level':'t1'} #(Peak emission energy (eV), disperison (eV)
s1s   = {0:(6.1,0.0), 1:(4,0.0), 'level':'s1'} # triplet energy, disperison (eV)
...
exciton   = morphology.Create_Particles('singlet', 50, method, mat=[0,1])
...
#bimolec_funcs_array = [morphology.anni_sing] 
#########################################################################################
