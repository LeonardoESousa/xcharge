...
FPnum = int(sys.argv[-1])
###BASIC PARAMETERS######################################################################
identifier         = 'CsPbI3_Bulk' #output identifier
...
k_diss = {Cs:k_dis, I:k_dis} # dissociation rates for each material combination
dissociation = DissociationFP(k=k_diss)

# FRENKEL PAIR ANNIHILATION
k_annihilation = {Cs:k_ann_FP0, I:k_ann_FP0} # annihilation rates for each material combination
annihilation_FP0 = Annihilation(k=k_annihilation)

k_annihilation = {Cs:k_ann_FP2, I:k_ann_FP2} # annihilation rates for each material combination
...
file = "../../CsPbI3_bulk.cif" #filename
remove_species = ['Pb']
multiply_cell  = [3,3,3]#[4,4,4] # multiplication of the unit cel by a vector v = a + b + c
...
FP   = morphology.Create_ParticlesFP(num=FPnum,pairs=generation_pairs) #ONLY CREATES FP2+
#########################################################################################
