...
nFP = int(sys.argv[-1])
###BASIC PARAMETERS######################################################################
identifier         = 'CsPbBr3_Bulk' #output identifier
...
###DEFECTS PROCESSES######################################################################
material_label  = {'Cs':0,'Br':1} #site indexing
Cs          = material_label['Cs']
Br          = material_label['Br']


# FRENKEL PAIR DISSOCIAITON
k_diss = {Cs:k_dis, Br:k_dis} # dissociation rates for each material combination
dissociation = DissociationFP(k=k_diss)

# FRENKEL PAIR ANNIHILATION
k_annihilation = {Cs:k_ann_FP0, Br:k_ann_FP0} # annihilation rates for each material combination
annihilation_FP0 = Annihilation(k=k_annihilation)

k_annihilation = {Cs:k_ann_FP2, Br:k_ann_FP2} # annihilation rates for each material combination
...
#file = "../../CsPbI3_bulk.cif" #filename
file = "../../CsPbBr3_bulk.cif" #filename
remove_species = ['Pb']
