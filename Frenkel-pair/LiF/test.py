...
cutoff              = 2.1      # in Angstroms
FPcutoff            = 2.1    #Frenkel pair maximum size allowed. Should not be higher than cutoff
...
remove_species = []
multiply_cell  = [5,5,5] # multiplication of the unit cel by a vector v = a + b + c
