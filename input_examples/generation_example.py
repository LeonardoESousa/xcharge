...
k_annihilation = {Cs:1e-5, I:0} # annihilation rates for each material combination
...
k_generation = 1E-15#{Cs:1e-8, I:0} # annihilation rates for each material combination
generation = FP_generation(k=k_generation)
###PROCESSES#############################################################################
...
generation = {'vacancy':[], 'interstitial':[], 'frenkelpair':[generation]}
#########################################################################################
