...
###BASIC PARAMETERS######################################################################
identifier         = 'forster_singlet_tripl' #output identifier
...
processes = {'singlet':[forster], 'triplet':[forster], 'electron':[forster],'hole':[forster]}
monomolecular = {'singlet':[fluor],'triplet':[phosp],'electron':[fluor],'hole':[fluor]}
#########################################################################################
...
exciton   = morphology.Create_Particles('singlet', 6, method, mat=[0,1],prob=True)
tripl     = morphology.Create_Particles('triplet', 4, method, mat=[0,1],prob=True)
