...
###BASIC PARAMETERS######################################################################
identifier         = 'test' #output identifier
...
kdiss = 0
k_diss = {(Cs,Cs):0, (Cs,I):kdiss, (I,Cs):0, (I,I):0} # dissociation rates for each material combination
dissociation = DissociationFP(k=k_diss)

# FRENKEL PAIR ANNIHILATION
k_anni = 1e-8
k_annihilation = {Cs:k_anni, I:k_anni} # annihilation rates for each material combination
annihilation = Annihilation(k=k_annihilation)

# VACANCY/INTERSTITIAL MIGRATION
kmig=0
k_migration = {(Cs,Cs):kmig, (Cs,I):0, (I,Cs):0, (I,I):kmig} # migration rates for each material combination
...
k_generation =k_anni*5E1#1E-5#{Cs:1e-8, I:0} # annihilation rates for each material combination
