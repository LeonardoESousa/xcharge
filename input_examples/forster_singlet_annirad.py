############################################################
# forster_singlet_annirad.py.                                        
# This example illustrates the simulation of singlet excitons with variable annihilation radius.
# 1 singlet excitons.
# 2 Materials.
############################################################
...
animation_exten    = 'mp4' # possible options ('gif' and 'mp4')
...
TT = Annihilation_Radius({('triplet','singlet'):{(0,0):0,(0,1):0,(1,1):0,(1,0):0}})
